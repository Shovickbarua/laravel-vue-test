    ...
    <div>
        <div v-if="message" class="alert-message">
          ...
          <div class="flex justify-between ">
                ...
                <div>
                    <RouterLink  to='/' class="mr-2 bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow mb-4">
                        Products
                    </RouterLink>
                                  ...
                                  <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                      <tr v-for="(product) in products" :key="product.id" class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                          ...
                                          <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            <div class="flex items-center">
                                                <img :src="product.image" class="h-14 w-20 object-fill rounded" />
                                          ...
                                          <!-- <td class="py-8 px-6 text-sm font-medium float-right whitespace-nowrap flex my-auto">
                                              <RouterLink :to="{ name: 'edit-item', params: { id: product.id }}" class="text-blue-600 dark:text-blue-500 hover:underline text-2xl"><Icon icon="ic:round-edit" /></RouterLink>
                                              <button @click.prevent="itemDelete(product.id)" class="ml-2 text-blue-600 dark:text-blue-500 hover:underline text-2xl"><Icon icon="ic:baseline-delete" /></button>
                                          </td> -->
                                      </tr>
                                  </tbody>
                              </table>
